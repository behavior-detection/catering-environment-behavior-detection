        ...
        >
          ...
          <div v-if="request.status === 'approved'" class="approval-result approved-result">
            ...
            <div class="result-details">
              ...
              <button
                class="btn-connect-webrtc"
                @click="goToWebRTCVisitor"
              >
                <i class="fas fa-share-alt"></i> 连接 Manager 获取文件
              </button>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    goToWebRTCVisitor() {
      this.$store.dispatch('navigation/setCurrentModule', 'WebRTCVisitor')
    }
  }
}
</script>
